...
export const RequestSchema = z.object({
    ...
    request_type: z.array(z.string()).nonempty({ message: "Select the type of request" }),
    contact_no: z.string().optional(),
    office: z.string().min(1, { message: "Select an office" }),
    agreed_timeline: z.string().optional(),
    remarks: z.string({ required_error: "Remarks is required." }).min(5, { message: "Must be greater than 5 characters." }),
